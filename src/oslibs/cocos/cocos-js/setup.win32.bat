...
rem js
xcopy /y/s cocos\scripting\js-sbindings\auto\*.h %DIOS_PREBUILT%\inc\cocos\
xcopy /y/s cocos\scripting\js-bindings\manual\*.h %DIOS_PREBUILT%\inc\cocos\
xcopy /y/s cocos\scripting\js-bindings\auto\*.hpp %DIOS_PREBUILT%\inc\cocos\
xcopy /y/s cocos\scripting\js-bindings\manual\*.hpp %DIOS_PREBUILT%\inc\cocos\
xcopy /y/s cocos\audio\include\*.h %DIOS_PREBUILT%\inc\cocos\
xcopy /y/s external\spidermonkey\include\win32\*.h %DIOS_PREBUILT%\inc\cocos\
xcopy /y/s external\spidermonkey\include\win32\*.msg %DIOS_PREBUILT%\inc\cocos\
